            ...
            {documents.slice(0, 6).map((document) => (
              <div key={document.id} className="rounded-3xl border border-slate-200 bg-slate-50 p-4">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  ...
                  <a className="inline-flex items-center justify-center rounded-2xl bg-slate-600 px-3 py-2 text-xs font-semibold text-white transition hover:bg-slate-700" href={`/api/documents/${document.id}/pdf?style=pos`} target="_blank" rel="noreferrer">Receipt (POS)</a>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="w-full max-w-6xl overflow-hidden rounded-[32px] bg-white shadow-2xl">
            <div className="flex flex-col gap-4 border-b border-slate-200 p-5 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <Button type="button" className="bg-slate-700 hover:bg-slate-800" onClick={() => window.open(`/api/documents/${previewDocumentId}/pdf?style=pos`, '_blank')}>Open Receipt (POS)</Button>
                <Button type="button" className="bg-slate-600 hover:bg-slate-700" onClick={() => window.open(`/api/documents/${previewDocumentId}/pdf`, '_blank')}>Print</Button>
