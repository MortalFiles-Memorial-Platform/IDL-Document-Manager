...
- Name: auth.spec.ts >> Dashboard E2E Tests >> User can navigate to Customers page
...
- generic [ref=e4]:
  - complementary [ref=e5]:
    - link "Interior Duct Ltd IDL-RIS Portal Welcome, Demo Manage documents, customers, inventory, approvals and compliance from one secure system." [active] [ref=e6] [cursor=pointer]:
      - /url: /
      - generic [ref=e7]:
